...
/* list/item.twig */
class __TwigTemplate_65f2b19a4c8c55fe6192cfb9b795ab5f7541529154dc149cf19bf8c682a4c81b extends Twig_Template
{
    ...
    ";
        // line 4
        if ((((isset($context["url"]) || array_key_exists("url", $context)) && twig_test_iterable((isset($context["url"]) ? $context["url"] : null))) &&  !twig_test_empty($this->getAttribute((isset($context["url"]) ? $context["url"] : null), "href", array(), "array")))) {
            // line 5
            echo "        <a";
...
";
    ...
    {
        return new Twig_Source("", "list/item.twig", "C:\\OSPanel\\domains\\Practice.local\\admin\\templates\\list\\item.twig");
    }
}
